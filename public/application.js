...
/***/ function(module, exports, __webpack_require__) {
	...
	var authHandler = __webpack_require__(8);
	var gameHandler = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNewGame = function onNewGame(event) {
	  ...
	  $('.win-banner').hide();
	  $('.changepassworderror').hide();
	  api.newGame().then(ui.newGameSuccess).catch(ui.newGamweFailure);
	};

	var onjoinGame = function onjoinGame(event) {
	  event.preventDefault();
	  api.joinGame().then(ui.joinGameSuccess).catch(ui.joinGameFailure);
	};

	var onUpdateBoard = function onUpdateBoard(data) {
	  data = events.data;
	  api.updateBoard(data).then(ui.updateBoardSuccess).catch(ui.updateBoardFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateBoardFailure = function updateBoardFailure(data) {};
	...
	var indexGameFailure = function indexGameFailure(data) {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkWinGame = function checkWinGame() {
